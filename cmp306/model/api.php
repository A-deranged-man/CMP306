<?php
	...
	*/
    ...
    function displaygridview(){
       ...
       item.image_id, image.image_name, image.image_alt FROM item, image 
       WHERE item.image_id = image.image_id ORDER BY item.item_id DESC" ;
        mysqli_stmt_prepare($stmt, $sql);
        mysqli_stmt_execute($stmt);
        $result = mysqli_stmt_get_result($stmt);
        $rows = array();
    ...
    */
    ...
    Functions for Block 3 work //End
